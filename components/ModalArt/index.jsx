            ...
            <div className="flex justify-center pt-20 mx-24">
              ...
              <div className="w-112 text-white px-10 my-auto">
                ...
                <div className="text-lg text-left">
                  ...
                  experiment for creative solutions to solve
                  <br />
                  - the trash and environmental issues.
                  <br />
                  - In this initial step, the art collective seeks for ways to
                  collaborate with SME businesses like, the Your Neighbor’s
                  Restaurant, to reduce the trash that is produced from the
                  business.
                  <br />
                  - Artists and the company sort through everyday trash and set a
                  goal together to create artworks from these trash for
                  permanent exhibiting at each of the company’s branches.
                </div>
              </div>
            </div>
          </div>
