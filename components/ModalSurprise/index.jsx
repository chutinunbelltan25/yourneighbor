          ...
          <div className="overflow-y-auto h-45">
            ...
            <div className="flex justify-center mx-60 pb-8">
              ...
              <div className="w-2/3 text-center my-auto text-core-white-100 mx-10 text-lg">
                A popular and fun moment to have in your party is available
                here. Simply order your cake with us and add this feature with
                the cake. The cake will come with a special stand that can pop
                your gift up on the cake. You can deliver us your selected gift
                or let us help you find the right present for your loved one!
              </div>
            </div>
          </div>
        </div>
